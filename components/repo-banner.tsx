...
const REPO_URL = 'https://github.com/onseason-ai/staycy'
...
export function RepoBanner({ className }: { className?: string }) {
  return (
    <a
      ...
      aria-label={'View Staycy repository on GitHub'}
      className={cn(
    ...
    >
      ...
      <div className="flex items-center gap-1 text-foreground/80" role="status" aria-live="polite">
        <StarFilledIcon
          className="w-4 h-4 transition-transform group-hover:text-primary duration-200 ease-in-out"
